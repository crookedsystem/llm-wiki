...
from personal_kb_mcp.domain.vault.service.result.search_notes_result import NoteMetadata
from personal_kb_mcp.domain.vault.service.vault_search_constants import SYNTHESIZED_PAGE_DIRS
